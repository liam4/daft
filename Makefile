...
js: src/main.js src/compile.js src/runtime.js src/type.js src/prims.js
	node_modules/.bin/browserify src/main.js -t babelify | node_modules/.bin/uglifyjs --mangle > _site/out.js
